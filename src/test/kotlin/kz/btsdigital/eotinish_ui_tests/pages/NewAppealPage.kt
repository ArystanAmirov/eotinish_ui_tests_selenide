...
class NewAppealPage {
    ...
    val zapros = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(4)")
    val zaprosyAdvokatov = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(5)")
    val zaprosyOPredostavleniiInformatsii = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(6)")
    val zaprosySMI = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(7)")
    val zaprosySudebnyhIspolnitelei = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(8)")
    val zayavlenie = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(9)")
    val otklik = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(10)")
    val predlozhenie = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(11)")
    val soobschenie = `$`("#kt_content > div > div > app-appeal-new > div.card.card-custom.gutter-b > div > form > div:nth-child(1) > div > div > app-select > div > div.dropdown-menu.menu.w-100.show > div > div:nth-child(12)")
